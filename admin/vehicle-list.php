                              ...
                              <table id="suvTable" class="table table-condensed table-hover table-sm text-sm">
                                  ...
                                  <tbody>
                                      <?php
                                        ...
                                        $exp_date = $vehicle_row['registration_expiry'];
                                        ...
                                        if($td > $exp){
                                            $expire = "Vehicle Registration is Expire";
                                        }else{
                                            $expire = "Vehicle Registration Will Expire Soon";
                                        }
                                      ?>
                                      <tr>
                                          <td><?= $number++; ?></td>
                                          ...
                                          <td  data-toggle="tooltip" data-placement="top" title="<?= $expire; ?>"><?= date('M d, Y', strtotime($vehicle_row['registration_expiry'])); ?></td>
                                          <td><?= $status; ?></td>
                                          <td>
